 ...
 */
@Entity
@Table(name = "cosdorgrolejobuser", schema = Constant.SCHEMA)
public class OrgRoleJobUser implements java.io.Serializable {
	...
	public OrgRoleJobUser() {
	}

	public OrgRoleJobUser(BigDecimal orgrolejobuserid) {
		this.orgrolejobuserid = orgrolejobuserid;
	}

	public OrgRoleJobUser(BigDecimal orgrolejobuserid, String username, String rolename, BigDecimal jobid,
	...
	@Id
	@SequenceGenerator(schema = Constant.SCHEMA,name  = "jobuserSeq", sequenceName = "jobuserSeq", allocationSize=1)
