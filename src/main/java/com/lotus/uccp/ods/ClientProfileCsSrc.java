...
/**
 * ClientProfileCsSrc generated by hbm2java
 */
import com.lotus.uccp.util.Constant; 
@Entity
@Table(schema = Constant.SCHEMANAME_ODS , name = "CLIENT_PROFILE_CS_SRC")
public class ClientProfileCsSrc implements java.io.Serializable {
	...
	public ClientProfileCsSrc() {
	}

	public ClientProfileCsSrc(BigDecimal clientProfileCsSeqNum) {
		this.clientProfileCsSeqNum = clientProfileCsSeqNum;
	}

	public ClientProfileCsSrc(BigDecimal clientProfileCsSeqNum, String clientId, String sourceSystemId,
