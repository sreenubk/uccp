...
/**
 * ClientProfileLglSrc generated by hbm2java
 */
import com.lotus.uccp.util.Constant; 
@Entity
@Table(schema = Constant.SCHEMANAME_ODS , name = "CLIENT_PROFILE_LGL_SRC")
public class ClientProfileLglSrc implements java.io.Serializable {
	...
	public ClientProfileLglSrc() {
	}

	public ClientProfileLglSrc(BigDecimal clientProfileLglSeqNum, String clientId, String sourceSystemId) {
